...
export class RatingsController {
  ...
  async create(@Request() req, @Body() createRatingDto: CreateRatingDto): Promise<Rating> {
  ...
  @ApiOperation({
    ...
    description: 'Retorna una lista paginada de todas las calificaciones del sistema',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  async findAll(@Query('page') page: number = 1, @Query('limit') limit: number = 20): Promise<Rating[]> {
  ...
  async getRecentRatings(@Query('limit') limit: number = 20): Promise<Rating[]> {
  ...
  @ApiOperation({
    ...
    description: 'Retorna una lista de profesionales ordenados por calificación promedio',
  })
  @ApiQuery({
    name: 'limit',
    required: false,
  ...
  @ApiResponse({
    status: 200,
    description: 'Lista de profesionales mejor calificados obtenida exitosamente',
    type: [TopRatedProfessionalDto],
  })
  async getTopRatedProfessionals(@Query('limit') limit: number = 10): Promise<TopRatedProfessionalDto[]> {
  ...
  @ApiOperation({
    ...
    description: 'Retorna todas las calificaciones realizadas por un usuario específico',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description: 'Retorna todas las calificaciones recibidas por un profesional',
  })
  @ApiResponse({
    status: 200,
  ...
  async findByProfessional(@Param('professionalId') professionalId: string): Promise<Rating[]> {
  ...
  @ApiOperation({
    ...
    description: 'Retorna solo las calificaciones que los clientes han hecho a un profesional',
  })
  @ApiResponse({
    status: 200,
  ...
  async getClientRatings(@Param('professionalId') professionalId: string): Promise<Rating[]> {
  ...
  @ApiOperation({
    ...
    description: 'Retorna estadísticas detalladas de calificaciones de un profesional',
  })
  @ApiResponse({
    status: 200,
  ...
  async getAverageRating(@Param('professionalId') professionalId: string): Promise<ProfessionalRatingStatsDto> {
  ...
  @ApiOperation({
    ...
    description: 'Retorna estadísticas de calificaciones dadas y recibidas por un usuario',
  })
  @ApiResponse({
    status: 200,
  ...
  async getUserRatingStats(@Param('userId') userId: string): Promise<UserRatingStatsDto> {
  ...
  @ApiOperation({
    ...
    description: 'Retorna todas las calificaciones relacionadas con una solicitud de servicio específica',
  })
  @ApiResponse({
    status: 200,
  ...
  async findByServiceRequest(@Param('serviceRequestId') serviceRequestId: string): Promise<Rating[]> {
  ...
  @ApiOperation({
    ...
    description: 'Permite a un usuario editar su calificación dentro de las primeras 24 horas',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description: 'Permite a un usuario eliminar su calificación si cumple las condiciones',
  })
  @ApiResponse({
    status: 204,
  ...
  async reportRating(
    ...
    return this.ratingsService.reportRating(id, req.user.id, reportRatingDto.reason);
  }
}
