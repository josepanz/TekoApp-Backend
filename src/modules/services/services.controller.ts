...
export class ServicesController {
  ...
  async createService(@Body() createServiceDto: CreateServiceDto, @Request() req: any) {
  ...
  async getNearbyServices(
    ...
    return this.servicesService.getNearbyServices(latitude, longitude, radius, categoryId);
  }
  ...
  @ApiResponse({ status: 404, description: 'Servicio no encontrado' })
  @ApiResponse({ status: 403, description: 'No autorizado para modificar este servicio' })
  async updateService(
    @Param('id', ParseUUIDPipe) id: string,
    @Body() updateServiceDto: UpdateServiceDto,
    @Request() req: any,
  ) {
    return this.servicesService.updateService(id, updateServiceDto, req.user.id);
  }
  ...
  @ApiResponse({ status: 404, description: 'Servicio no encontrado' })
  @ApiResponse({ status: 403, description: 'No autorizado para cancelar este servicio' })
  async cancelService(
    @Param('id', ParseUUIDPipe) id: string,
  ...
  @ApiResponse({ status: 404, description: 'Servicio no encontrado' })
  @ApiResponse({ status: 403, description: 'No autorizado o no es profesional' })
  async acceptService(
    @Param('id', ParseUUIDPipe) id: string,
    @Request() req: any,
  ) {
  ...
  @ApiResponse({ status: 404, description: 'Servicio no encontrado' })
  @ApiResponse({ status: 403, description: 'No autorizado para calificar este servicio' })
  async rateService(
    @Param('id', ParseUUIDPipe) id: string,
  ...
  @Post(':id/requests')
  @ApiOperation({ summary: 'Crear una solicitud para un servicio (solo profesionales)' })
  ...
  async createServiceRequest(
    ...
    return this.servicesService.createServiceRequest(serviceId, requestDto, req.user.id);
  }
  ...
  @ApiResponse({ status: 403, description: 'No autorizado para responder esta solicitud' })
