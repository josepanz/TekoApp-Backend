...
- permissions-db.service.spec.ts
- compilerOptions
- auth.service.spec.ts
- ServicesController
- TekoApp-Backend README
...
- Permissions
- users-db.service.spec.ts
- AppConfig
- services.controller.spec.ts
- JwtAuthGuard
- roles-permission/dtos/response/index.ts
- d3.v3.min.js
...
- payment-db.service.spec.ts
- CreateCategoryDto
- payments.service.spec.ts
- services.controller.ts
- PromotionsController
- Get
- auth/dtos/response/index.ts
...
- tacking-db.service.spec.ts
- hi
- context.md — Project State
- RolesApiController
- roles-permission-db/services/user-roles-db.service.spec.ts
- services-db.service.spec.ts
- dependencies
- PromotionDetailResponseDTO
- user-permissions-db.service.spec.ts
- Wl
- ScheduleConfig
- health.controller.spec.ts
- exclude
- promotions.service.spec.ts
- UsersRolesApiController
...
- UserRolesDBService
- roles-permission-api.service.spec.ts
- countries.controller.ts
- users-api.service.spec.ts
- @prisma/client
- GetNearbyProfessionalsRequestDTO
...
- services.service.ts
- file-uploader.decorator.ts
- UploadMerchantDocsRequestDTO
- .findSubcategories
- PaymentTrendsQueryDTO
- tekoapp-backend Project Overview (CLAUDE.md)
- Session 8 — Migration to -db modules (ratings, services, promotions)
- Sesión 11 — Lint limpio: 0 errors, 0 warnings
...
- notifications-db.service.spec.ts
...
- services/dtos/request/index.ts
- edit-context.response.dto.ts
- e
- TrackingController
- rules/typescript.md
- compilerOptions
...
- ProcessPaymentPollingDto
- ._toggleEventListeners
- file-download.interceptor.ts
...
- .resize
- lit-html.js
- users-roles-api.controller.spec.ts
- AsyncManager
- locations-db.service.spec.ts
- dx
- Session 13 — git history cleanup / CI notes fix
- /graphify skill
...
- i18n.helper.ts
- custom-http-response-helper.helper.ts
- is-order-by-format.validator.ts
- CacheKeyHelper
- q_
- categories.module.ts
- GetProfessionalsAreaQueryDTO
- locations.module.ts
- payments.module.ts
- UserIdParamDTO
- FormatHelper
...
- rb
- zepto.min.js
- cache-ttl.constant.ts
- DatabaseHelper
- .hide
- Transcribe Video/Audio Files Step (Graphify)
- CreateResponseDataDTO
- CardHelper
- ErrorHelper
- LocalAuthGuard
- Tx
...
- .needsRefresh
- template-playground.component.ts
- payments.service.ts
...
5. `UsersDBService` - 72 edges
6. `IUserDataOnJwt` - 71 edges
7. `ug()` - 55 edges
8. `hi()` - 53 edges
9. `O()` - 52 edges
10. `t()` - 50 edges
...
- `ug()` --indirect_call--> `ft()`  [INFERRED]
  docs/js/libs/vis-network.min.js → docs/js/libs/d3.v3.min.js
...
### Community 3 - "scripts"
Cohesion: 0.09
Nodes (23): scripts, build, check:types, docs:generate, docs:json, docs:rebuild, docs:serve, docs:update-readme (+15 more)
...
Cohesion: 0.05
Nodes (39): mockGetMyProfessionalProfile, mockGetNearbyProfessionals, mockGetProfessionalById, mockGetProfessionalByReference, mockGetProfessionalReviews, mockGetProfessionals, mockGetProfessionalServices, mockGetProfessionalStats (+31 more)

### Community 26 - "report.service.ts"
Cohesion: 0.17
...
### Community 33 - "auth/dtos/request/index.ts"
Cohesion: 0.05
...
### Community 47 - "services.controller.spec.ts"
Cohesion: 0.08
...
Cohesion: 0.20
Nodes (18): NotificationsController, ApiBearerAuth, ApiOperation, ApiResponse, ApiTags, Body, Controller, Delete (+10 more)

### Community 57 - "services.service.spec.ts"
Cohesion: 0.09
...
### Community 66 - "ratings.service.spec.ts"
Cohesion: 0.09
...
Cohesion: 0.10
Nodes (19): mockCategoryFindUnique, mockPrisma, mockProfessionalsFindUnique, mockServiceRequestsCreate, mockServiceRequestsFindFirst, mockServiceRequestsFindMany, mockServiceRequestsFindUnique, mockServiceRequestsUpdate (+11 more)
...
### Community 83 - "health.controller.spec.ts"
Cohesion: 0.12
Nodes (14): HealthCheck, InjectConnection, HealthController, PackageJson, mockCheckHeap, mockCheckStorage, mockHealthCheck, mockMongoosePingCheck (+6 more)

### Community 84 - "exclude"
Cohesion: 0.12
Nodes (16): console, dist, docs, **/*.e2e-spec.ts, jest.config.d.ts, jest.config.js, jest.config.js.map, jest.config.ts (+8 more)

### Community 85 - "promotions.service.spec.ts"
Cohesion: 0.12
...
Cohesion: 0.21
Nodes (11): mockGetNearbyProviders, mockProcessLocationPing, ApiProperty, IsNumber, IsOptional, IsUUID, Max, Min (+3 more)

### Community 88 - "notifications.controller.ts"
Cohesion: 0.08
Nodes (24): IsMongoId, FcmTokenReferenceIdParamDTO, ApiProperty, IsUUID, FindAllNotificationsQueryDTO, ApiPropertyOptional, IsNumber, IsOptional (+16 more)

### Community 89 - "UpdateLocationRequestDTO"
Cohesion: 0.15
...
Cohesion: 0.07
Nodes (36): CountriesController, mockFindAll, mockFindOne, ApiTags, Controller, Get, Param, Query (+28 more)
...
Cohesion: 0.17
Nodes (10): Get, Query, GetNearbyProfessionalsRequestDTO, ApiProperty, ApiPropertyOptional, IsNumber, IsOptional, Max (+2 more)

### Community 98 - "GetServicesListQueryDTO"
Cohesion: 0.16
Nodes (12): GetServicesDocs(), GetServicesListQueryDTO, ApiPropertyOptional, IsEnum, IsInt, IsNumber, IsOptional, Max (+4 more)

### Community 99 - "categories.controller.spec.ts"
Cohesion: 0.14
...
### Community 118 - "Session 8 — Migration to -db modules (ratings, services, promotions)"
Cohesion: 0.24
...
### Community 119 - "Sesión 11 — Lint limpio: 0 errors, 0 warnings"
Cohesion: 0.18
...
### Community 124 - "CreateProfessionalToClientRatingRequestDTO"
Cohesion: 0.17
...
### Community 129 - "nk"
Cohesion: 0.16
Nodes (3): gs(), nk, setModuleOptions()

### Community 130 - "CreateNotificationRequestDTO"
Cohesion: 0.18
...
### Community 138 - "Incremental Update (--update)"
Cohesion: 0.20
...
### Community 139 - "deep-iterator.js"
Cohesion: 0.13
Nodes (28): $s, a(), b(), c(), e(), f(), h(), i() (+20 more)

### Community 140 - "GetNearbyProfessionalsQueryDTO"
Cohesion: 0.20
Nodes (9): GetNearbyProfessionalsQueryDTO, ApiProperty, ApiPropertyOptional, IsInt, IsNumber, IsOptional, Max, Min (+1 more)

### Community 141 - "custom-elements.min.js"
Cohesion: 0.14
Nodes (22): A(), B(), ba(), C(), da(), E(), F(), G() (+14 more)
...
Cohesion: 0.17
Nodes (9): TrackingController, Body, Controller, Post, ApplyTrackingControllerDocs(), TrackingModule, Module, TrackingDbModule (+1 more)

### Community 146 - "rules/typescript.md"
Cohesion: 0.28
...
### Community 148 - "AnalyticsQueryDto"
Cohesion: 0.22
...
Cohesion: 0.13
Nodes (14): makeReq(), mockCreate, mockDelete, mockFindAll, mockFindUnread, mockGetUnreadCount, mockGetVapidPublicKey, mockMarkAllAsRead (+6 more)

### Community 152 - "payment-stats.dto.ts"
Cohesion: 0.39
...
### Community 153 - "ProcessPaymentPollingDto"
Cohesion: 0.22
...
Cohesion: 0.14
Nodes (25): A(), _arrayWithoutHoles(), _assertThisInitialized(), b(), _classCallCheck(), _createClass(), _defineProperties(), f() (+17 more)

### Community 163 - "users-roles-api.controller.spec.ts"
Cohesion: 0.20
...
### Community 167 - "Session 13 — git history cleanup / CI notes fix"
Cohesion: 0.38
...
### Community 172 - "ReportRatingRequestDTO"
Cohesion: 0.29
...
### Community 189 - "ReversePaymentDto"
Cohesion: 0.40
Nodes (4): ReversePaymentDto, IsNotEmpty, IsString, MinLength

### Community 190 - "http-response.doc.ts"
Cohesion: 0.53
...
Cohesion: 0.18
Nodes (10): Arquitectura de notificaciones push — decisión, implementación y estado (actualizado 2026-08-02), Endpoints nuevos (todos JWT-only, mismo guard que el resto de `/notifications`), Estado actual, Frontend Web — implementado, Mobile (Flutter, cuando arranque) — sin cambios respecto al backlog original, Nota sobre autenticación de SSE, Por qué FCM para mobile (no un servicio propio), Por qué SSE Y Web Push (no uno u otro) (+2 more)
...
### Community 339 - "search.js"
Cohesion: 0.31
Nodes (7): bindSearch(), displayResults(), getParameterByName(), launchSearch(), launchSearchFromQueryString(), throttle(), updateQueryString()

### Community 340 - "HbsRenderService"
Cohesion: 0.24
Nodes (4): HbsRenderService, Injectable, handlebars, handlebars

### Community 341 - "tracking.docs.ts"
Cohesion: 0.36
